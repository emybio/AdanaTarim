...
/**
 * Ratio between font size and font height. The number comes from jspdf's source
 * code
 */
...
function printFullRow(row, drawRowHooks, drawCellHooks) {
    ...
    if (!canFitOnPage(row.height)) {
        if (row.maxLineCount <= 1) {
            ...
            // Modify the row to fit the current page and calculate text and
			// height of partial row
            ...
            for (var j = 0; j < table.columns.length; j++) {
                ...
                // Splice with negative values results in unexpected results,
				// therefore eliminate
                // scenarios where less than one line is remaining, but are
				// shown
...
// implementation from
// https://github.com/es-shims/es5-shim/blob/v3.4.0/es5-shim.js#L1304-L1324
var ws = [
...
var ES6 = assign(assign({}, ES5), {
	...
	IsConstructor: function IsConstructor(argument) {
		return typeof argument === 'function' && !!argument.prototype; // unfortunately
																		// there's
																		// no
																		// way
																		// to
	...
	/**
	 * 7.3.2 GetV (V, P) 1. Assert: IsPropertyKey(P) is true. 2. Let O be
	 * ToObject(V). 3. ReturnIfAbrupt(O). 4. Return O.[[Get]](P, V).
	 */
	...
	/**
	 * 7.3.9 - http://www.ecma-international.org/ecma-262/6.0/#sec-getmethod 1.
	 * Assert: IsPropertyKey(P) is true. 2. Let func be GetV(O, P). 3.
	 * ReturnIfAbrupt(func). 4. If func is either undefined or null, return
	 * undefined. 5. If IsCallable(func) is false, throw a TypeError exception.
	 * 6. Return func.
	 */
	...
	/**
	 * 7.3.1 Get (O, P) -
	 * http://www.ecma-international.org/ecma-262/6.0/#sec-get-o-p 1. Assert:
	 * Type(O) is Object. 2. Assert: IsPropertyKey(P) is true. 3. Return
	 * O.[[Get]](P, O).
	 */
	...
	ArraySpeciesCreate: function ArraySpeciesCreate(originalArray, length) {
		...
		if (isArray) {
			...
			// TODO: figure out how to make a cross-realm normal Array, a
			// same-realm Array
 ...
 * 
 * @param {Object[]|String[]}
 *            headers Either as an array of objects or array of strings
 * @param {Object[][]|String[][]}
 *            data Either as an array of objects or array of strings
 * @param {Object}
 *            [userOptions={}] Options that will override the default ones
 */
jsPDF.API.autoTable = function (headers, data, tableOptions) {
    ...
    // Don't call global and document addPageContent more than once for each
	// page
 ...
 *            If to include hidden rows and columns (defaults to false)
...
/**
 * Improved text function with halign and valign support Inspiration from:
...
/**
 * @deprecated Use jsPDF.autoTableSetDefaults({addPageContent: function() {}})
 *             instead
 */
