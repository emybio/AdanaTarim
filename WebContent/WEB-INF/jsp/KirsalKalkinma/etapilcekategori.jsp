...
<body>
	<div class="container ">
		<img id="loader" width="100px"
			src="<c:url value='/assets/images/copper-loader.gif'/>">
	</div>
	<div class="container-fluid ekonomikRapor" id="yazdir">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							<!-- onclick="tableToExcel('ilceKategoriEtap', 'Kategori ve İlçeye Göre Rapor')"
							onclick="selectElementContents( document.getElementById('ilceKategoriEtap') );" -->
							<a href="#" class="float-left btn" id="dlink"
								onclick="selectElementContents( document.getElementById('ilceKategoriEtap') );"><img
								alt="Excel Report" class="rounded" width="35px"
								src="<c:url value='/assets/images/copy-file.png'/>">Tabloyu
								Kopyalamak İçin Tıklayınız..</a>
						</h3>
					</div>
					<div class="panel-body">
