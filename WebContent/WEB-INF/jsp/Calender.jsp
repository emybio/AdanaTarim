						...
						.fullCalendar(
								{
									...
									drop : function(date, allDay) { // this function is called when something is dropped
										...
										var originalEventObject = jq(this)
												.data('eventObject');

										// we need to copy it, so that multiple events don't have a reference to the same object
										var copiedEventObject = jq.extend({},
												originalEventObject);
...
body {
	...
	background:
		...
		url("./assets/images/bigstock-Abstract-Blurred-Background-Of-92820527.jpg");
	margin-bottom: 40px;
}
